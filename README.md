...
* **Total Probabilistic Mass:** The dataset's total continuous probability mass, containing both unique and redundant signal volume and idiosyncratic noise (Structural Uncertainty and independent measurement error) volume.
